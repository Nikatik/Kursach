...
CFLAGS := -Wall -Wextra -Wfloat-equal -O -MMD -Woverloaded-virtual -Wold-style-cast -Wundef -Wshadow -Wcast-align -Wconversion -Wunreachable-code -ftrapv -pedantic -std=c++20 -Wformat=2 -Wformat-overflow=2 -Wreturn-type -Wdouble-promotion -Wstrict-overflow=5 -Wconversion
